module github.com/meteocima/wrfassim
...
require (
	...
	github.com/meteocima/radar2wrf v1.0.0
...
//replace github.com/meteocima/namelist-prepare => /rhomes/andrea.parodi/repos/namelist-prepare
